...
gpu.set(4, 30, "Start the game and look for fields without mines. If 3 times")
gpu.set(4, 31, "did not stumble upon a field with a mine in a row, then you")
gpu.set(4, 32, "won. There are 24 fields in the game, of which 5")
gpu.set(4, 33, "mined. Winning the game doubles the bet.")
gpu.setBackground(0xe0e0e0)
gpu.fill(1, 27, 76, 1, " ")
gpu.fill(54, 27, 2, 12, " ")
gpu.setForeground(0xFFFFFF)
